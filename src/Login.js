  ...
  return (
    ...
    <div className='block md:flex'>
      ...
      <div className='bg-mobilebgImage md:bg-bgImage bg-130% md:bg-contain bg-no-repeat w-1/2 md:h-screen'>
        ...
        <p 
          className='motto text-white text-sm w-20 md:w-auto md:text-4xl relative bottom-10 md:mt-3 md:top-14 md:left-20'>
          ...order your best meal!
        </p>
      </div>
     ...
     {/* div for right section */}
      <div className='hidden md:block '>
        <form className='mt-20 px-10 relative top-20 '>
          ...
          <div className='relative'>
            <h2 className='text-center text-3xl login-text mb-3 tracking-wide '>Login</h2>
          ...
          <button type='submit' className='login-btn bg-border-color text-white p-2 px-10 rounded-md hover:opacity-75 relative left-24'>LOGIN</button>
        </form>
      </div>
      ...
      <div className='block md:hidden'>
        ...
        <div className='relative'>
            <h2 className='text-center text-xs login-btn mb-3 tracking-wide '>Login to your account</h2>
            <hr className='bg-border-color h-1 w-11 mb-3 relative left-36' />
        </div>
        ...
        <div>
          <form className='px-10 mt-10'>
            ...
            <p className=' text-border-color italic text-sm hover:opacity-75 hover:cursor-pointer hover:underline mb-5'>Forgot Password?</p>
            <button type='submit' className='login-btn bg-border-color text-white p-2 px-10 rounded-md hover:opacity-75'>LOGIN</button>
          </form>
        </div>
      </div>
    </div>
